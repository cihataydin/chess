        ...
        public static void Yerlestir(List<Kare> kareler)
        {
            foreach (Kare kare in kareler)
            {
                if (kare.Koordinat.Y == 2)
                {
                    ...
                    kare.Button.Image = Image.FromFile($"{Environment.CurrentDirectory}{TasResimleri.BEYAZPIYON}");
                ...
                if (kare.Koordinat.Y == 7)
                {
                    ...
                    kare.Button.Image = Image.FromFile($"{Environment.CurrentDirectory}{TasResimleri.SIYAHPIYON}");
                    kare.Durum = KareDurum.Dolu;
